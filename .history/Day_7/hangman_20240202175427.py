...
4. Add a way to show the word at the end of the game.
6. Custom game board.
7. Add custom words using a file.
8. If letter is already guessed, don't decrement lives.
9. Add a way to show the letters that have been guessed.
"""
